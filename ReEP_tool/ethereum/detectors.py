...
class DetectSuicidal1(Detector):
    ARGUMENT = "suicidal2"
    HELP = "Reachable selfdestruct instructions"
    IMPACT = DetectorClassification.MEDIUM
    CONFIDENCE = DetectorClassification.HIGH
...
class DetectExternalCallAndLeak1(Detector):
    ARGUMENT = "ext-call-leak1"
    HELP = "Reachable external call or ether leak to sender or arbitrary address1"
    IMPACT = DetectorClassification.MEDIUM
    CONFIDENCE = DetectorClassification.HIGH
