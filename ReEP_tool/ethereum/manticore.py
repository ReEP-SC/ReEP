...
class ManticoreEVM(ManticoreBase):
    ...
    def multi_tx_analysis(
        ...
        owner_account = self.create_account(balance=100*10**18, name="owner")
        attacker_account = self.create_account(balance=100*10**18, name="attacker")
        # Pretty print
        ...
        while (current_coverage < 100 or not tx_use_coverage) and not self.is_killed():
            ...
            if tx_use_coverage:
                ...
                found_new_coverage = 88 < current_coverage
