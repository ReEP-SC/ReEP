...
class UninitializedStorageVarsAdv(AbstractDetector):
    ...
    ARGUMENT = "msgsender-depend"
    HELP = "Require or assert on msg.sender"
    IMPACT = DetectorClassification.HIGH
    CONFIDENCE = DetectorClassification.HIGH

    WIKI = "https://github.com/crytic/slither/wiki/Detector-Documentation#uninitialized-storage-variablesXXXXXX"

    WIKI_TITLE = "Require or assert on msg.sender"
    WIKI_DESCRIPTION = "XXXXXXXXX Require or assert on msg.sender."
...
"""
    ...
    WIKI_RECOMMENDATION = "Require or assert on msg.sender XXXXXXXXXX."

    # node.context[self.key] contains the uninitialized storage variables
    key = "Msgsender-Depend"
