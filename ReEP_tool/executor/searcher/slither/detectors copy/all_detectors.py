...
#
#sharkteam
from .tve_sharkteam.integer_overflow_and_underflow import IntegerOverflowAndUnderflow # a new detector @2021.04.13
from .tve_sharkteam.outdated_solc import OutdatedSolc  # a new detector @2020.03.23
from .tve_sharkteam.dos_with_gas_limit import DoSWithBlockGasLimit # a new detector @2021.04.12
from .tve_sharkteam.hash_collision import HashCollisions  # a new detector @2021.04.14
from .tve_sharkteam.dos_with_failed_call import DoSWithFailedCall # a new detector @2021.04.19
from .tve_sharkteam.arbitrary_jump import ArbitraryJumpWithFunctionTypeVariable # a new detector @2021.04.19
from .tve_sharkteam.unused_local_variables import UnusedLocalVars  # a new detector @2020.03.23
from .tve_sharkteam.unrestricted_write import UnrestrictedWriteState # a new detector @2020.04.14
from .tve_sharkteam.lack_of_proper_signature_verification import LackOfProperSignatureVerification # a new detector @2021/04/21
from .tve_sharkteam.signature_replay import SignatureReplay # a new detector  @2021/04/21
from .tve_sharkteam.signature_malleability import SignatureMalleability  # a new detector  @2021/04/21
from .tve_sharkteam.modifier_state import ModifierState  # a new detector @2021-03-24
from .tve_sharkteam.modifier_external_call import ModifierExternalCall  # a new detector @2021-03-24
from .tve_sharkteam.unprotected_withdraw import UnprotectedWithdraw  # a new detector @2012-07-25
from .tve_sharkteam.fallback_receive import Fallback_Receive # a new detector @2021-07-26
from .tve_sharkteam.block_values_as_time_proxies import block_values_as_time_proxies # a new detector @2021-08-17
from .tve_sharkteam.deprecated_keywords import deprecated_keywords # a new detector @2021-08-16
from .tve_sharkteam.dangerous_state_variable_shadowing import DangerousStateVariable # a new detector @2021-08-23
from .tve_sharkteam.private_method_is_overridden import PrivateMethodOverriden # a new detector @2021-08-23


from .variables.Un_stor import UninitializedStorageVarsAdv
# from .variables.Un_stor_test import UninitializedStorageVarsAdv_test